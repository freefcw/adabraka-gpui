...
```bash
cargo test -p fc-gpui-core --test real_visual_smoke --features test-support -- --ignored
```
...
```bash
cargo test -p fc-gpui-core real_visual --features test-support,wayland,x11 -- --ignored
```
...
```bash
cargo test -p fc-gpui-core --lib --features test-support -- visual_test_capabilities
cargo test -p fc-gpui-core --lib --features test-support -- visual_test_mock_render_artifact
cargo test -p fc-gpui-core --lib --features test-support -- visual_test_render_to_image
cargo test -p fc-gpui-core --test real_visual_smoke --features test-support
cargo test -p fc-gpui-core --test real_visual_smoke --features test-support -- --ignored
```
...
cargo test -p fc-gpui-core --lib --features test-support -- visual_test
...
echo "  cargo test -p fc-gpui-core --test real_visual_smoke --features test-support -- --ignored"
