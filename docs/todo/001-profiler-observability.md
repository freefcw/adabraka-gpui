...
cargo test -p fc-gpui-core --lib --features test-support -- profiler_enabled
cargo test -p fc-gpui-core --lib --features test-support -- profiler_disabled
cargo test -p fc-gpui-core --lib --features test-support -- profiler_concurrent
...
echo "  cargo test -p fc-gpui-core --lib --features test-support -- profiler_overhead --ignored"
