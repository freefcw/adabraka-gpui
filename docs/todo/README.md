...
| 3 | Visual Test Platform | `003-visual-test-platform.md` | 进行中（能力探测、mock artifact、macOS real smoke 已完成；screenshot 待迁移） | TestDispatcher deterministic clock 能力稳定 | 中 |
