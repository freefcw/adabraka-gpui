...
| 3 | Visual Test Platform | `003-visual-test-platform.md` | 进行中（能力探测、mock artifact、macOS real smoke、render_to_image 接口已完成；screenshot readback 待迁移） | TestDispatcher deterministic clock 能力稳定 | 中 |
