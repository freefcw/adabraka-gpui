...
use core_graphics::{base::CGFloat, display::CFDictionary, geometry::CGAffineTransform};
use core_text::{
    ...
    font_descriptor::{
        ...
        CTFontDescriptorCreateWithAttributes, CTFontDescriptorRef, TraitAccessors,
        kCTFontCascadeListAttribute, kCTFontFamilyNameAttribute, kCTFontFeatureSettingsAttribute,
        kCTFontItalicTrait, kCTFontSlantTrait, kCTFontTraitsAttribute, kCTFontWeightTrait,
    },
};
