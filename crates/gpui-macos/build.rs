...
mod macos {
    ...
    fn generate_shader_bindings() -> PathBuf {
        ...
        let gpui_dir = PathBuf::from(gpui::GPUI_MANIFEST_DIR);
        ...
        let local_src_paths = [crate_dir.join("src/mac/metal_renderer.rs")];
    ...
    fn emit_stitched_shaders(header_path: &Path) {
        ...
        let shader_source_path = "./src/mac/shaders.metal";
    ...
    fn compile_metal_shaders(header_path: &Path) {
        ...
        let shader_path = "./src/mac/shaders.metal";
