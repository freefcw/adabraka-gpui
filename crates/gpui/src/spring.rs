...
mod tests {
    ...
    #[test]
    fn interpolates_pixels_and_rems() {
        assert_eq!(
            AnimationPhase(0.25).interpolate(Pixels::from(0.0), Pixels::from(40.0)),
            Pixels::from(10.0)
        );
        assert_eq!(
            AnimationPhase(0.5).interpolate(Rems(2.0), Rems(4.0)),
            Rems(3.0)
        );
    }
