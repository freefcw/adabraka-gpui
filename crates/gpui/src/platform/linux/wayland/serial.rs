...
impl SerialTracker {
    ...
    ///
    /// Wayland compositor serial numbers are monotonically increasing, so the highest value is the
    /// most recently received one. This is the correct serial to use for clipboard writes that may
    /// have been triggered by a mouse press instead of a key press.
