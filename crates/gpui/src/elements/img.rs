...
mod tests {
    ...
    fn image_object_fit_cover_crops_to_element_bounds(cx: &mut TestAppContext) {
        ...
        let full_tile_bounds = cx.update(|window, _| {
            window
                .rendered_frame
                .scene
                .polychrome_sprites
        ...
        cx.draw(point(px(10.), px(20.)), size(px(100.), px(100.)), |_, _| {
        ...
        let (rendered_bounds, rendered_tile_bounds, scale_factor) = cx.update(|window, _| {
            let sprite = window
                .rendered_frame
                .scene
                .polychrome_sprites
    ...
    fn image_object_fit_cover_clamps_corner_radii_to_visible_bounds(cx: &mut TestAppContext) {
        ...
        let (corner_radius, expected_corner_radius) = cx.update(|window, _| {
            (
                window
                    .rendered_frame
                    .scene
