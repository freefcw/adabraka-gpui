...
//! the sprite atlas hands out tiles without uploading pixels. This lets
//! command-line tools drive real `Window`-based code paths without a display
//! server.
...
impl rwh::HasWindowHandle for HeadlessWindow {
    fn window_handle(&self) -> std::result::Result<rwh::WindowHandle<'_>, rwh::HandleError> {
        Err(rwh::HandleError::NotSupported)
    }
}

impl rwh::HasDisplayHandle for HeadlessWindow {
